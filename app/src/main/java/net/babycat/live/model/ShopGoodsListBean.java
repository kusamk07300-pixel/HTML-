...
public class ShopGoodsListBean {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof ShopGoodsListBean;
    }
    ...
    public int hashCode() {
        ...
        String updateTime = getUpdateTime();
        return (iHashCode34 * 59) + (updateTime != null ? updateTime.hashCode() : 43);
    }
    ...
    public String toString() {
        return "ShopGoodsListBean(id=" + getId() + ", type=" + getType() + ", name=" + getName() + ", subName=" + getSubName() + ", cateId=" + getCateId() + ", unit=" + getUnit() + ", sliderImage=" + getSliderImage() + ", videoSrc=" + getVideoSrc() + ", sales=" + getSales() + ", views=" + getViews() + ", collects=" + getCollects() + ", spec=" + getSpec() + ", price=" + getPrice() + ", costPrice=" + getCostPrice() + ", originalPrice=" + getOriginalPrice() + ", postage=" + getPostage() + ", spu=" + getSpu() + ", stock=" + getStock() + ", weight=" + getWeight() + ", volume=" + getVolume() + ", userLabel=" + getUserLabel() + ", isShow=" + getIsShow() + ", isHot=" + getIsHot() + ", isRecommend=" + getIsRecommend() + ", isNew=" + getIsNew() + ", isDel=" + getIsDel() + ", deliverType=" + getDeliverType() + ", shippingTplId=" + getShippingTplId() + ", freight=" + getFreight() + ", seoTitle=" + getSeoTitle() + ", seoKeywords=" + getSeoKeywords() + ", seoDesc=" + getSeoDesc() + ", commission=" + getCommission() + ", createTime=" + getCreateTime() + ", updateTime=" + getUpdateTime() + ")";
    }
}
