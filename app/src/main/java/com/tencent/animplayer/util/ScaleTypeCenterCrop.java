...
public final class ScaleTypeCenterCrop implements IScaleType {
    ...
    private final Pair<Integer, Integer> getCenterCropSize(int i10, int i11, int i12, int i13) {
        float f10 = i10;
        float f11 = i11;
        float f12 = i12 / i13;
        if (f10 / f11 > f12) {
    ...
    public FrameLayout.LayoutParams getLayoutParam(int i10, int i11, int i12, int i13, @k FrameLayout.LayoutParams layoutParams) {
        ...
        int iIntValue = centerCropSize.a().intValue();
        int iIntValue2 = centerCropSize.b().intValue();
